...
const terminalLines = [
  { type: 'prompt' as const, content: 'whoami', delay: 1000 },
  { type: 'output' as const, content: 'matthew', delay: 500 },
  { type: 'prompt' as const, content: 'cat /etc/passwd | grep matthew', delay: 1200 },
  { type: 'output' as const, content: 'matthew:x:1000:1000:Security Engineer:/home/matthew:/bin/bash', delay: 800 },
  { type: 'prompt' as const, content: 'ls -la ~/projects/', delay: 1000 },
  { type: 'output' as const, content: 'drwxr-xr-x 2 matthew matthew 4096 Apr 15 17:20 log-correlation-engine', delay: 600 },
  { type: 'output' as const, content: 'drwxr-xr-x 2 matthew matthew 4096 Apr 15 17:20 sigma-detection-rules', delay: 400 },
  { type: 'output' as const, content: 'drwxr-xr-x 2 matthew matthew 4096 Apr 15 17:20 devsecops-pipeline', delay: 400 },
  { type: 'output' as const, content: 'drwxr-xr-x 2 matthew matthew 4096 Apr 15 17:20 aws-infrastructure', delay: 400 },
  { type: 'prompt' as const, content: 'sudo systemctl status security-onion', delay: 1200 },
  { type: 'success' as const, content: '● security-onion.service - Security Onion', delay: 600 },
  { type: 'success' as const, content: '   Loaded: loaded (/lib/systemd/system/security-onion.service; enabled)', delay: 400 },
  { type: 'success' as const, content: '   Active: active (running) since Mon 2026-04-15 17:20:01 EDT; 2h 15min ago', delay: 400 }
]
